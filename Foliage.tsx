...
const vertexShader = `
  ...
  void main() {
    ...
    vec3 goldColor = vec3(204.0/255.0, 153.0/255.0, 255.0/255.0);
    vec3 emeraldColor = vec3(204.0/255.0, 153.0/255.0, 255.0/255.0);
    vec3 brightPurple = vec3(204.0/255.0, 153.0/255.0, 255.0/255.0);
    
    // Sparkle effect
    float sparkle = sin(uTime * 5.0 + aRandom * 100.0);
    vec3 finalPurple = mix(emeraldColor, brightPurple, aRandom * 0.3);
    
    // Use the purple blend directly so the particles appear purple
    vColor = finalPurple;
